...
def plotLatency():
    ...
    # Show the plot
    # plt.show()
    plt.savefig("graphs2/Latency_of_packets.png")
...
def plotRemainingTime():
    ...
    # Show the plot
    # plt.show()
    plt.savefig("graphs2/Remaining_deadlines.png")
...
def plotCPUidleTime():
    ...
    # Show the plot
    # plt.show()
    plt.savefig("graphs2/cpu_idle_time.png")
...
def plotSatisfactionRate():
    ...
    plt.legend()
    # plt.show()
    plt.savefig("graphs2/Satisfaction_rate.png")
...
def plotProcessedRate():
    ...
    plt.legend()
    # plt.show()
    plt.savefig("graphs2/ProcessRate.png")